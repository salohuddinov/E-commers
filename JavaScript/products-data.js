const products = [
  ...
  },
  {
    ...
    category: "Fruit",
    description:
      "Колбаса сырокопченая МЯСНАЯ ИСТОРИЯ Сальчичон и Тоскан... В корзину",
      price: 71,
    rating: 5,
    discount: 20,
  ...
  },
  {
    ...
    category: "Bakery",
    description:
      "A Молоко ПРОСТОКВАШИНО паст. питьевое цельное отборное....",
    price: 88,
    rating: 5,
    discount: 20,
  ...
  },
  {
    ...
    category: "Dairy",
    description:
      "Молоко ПРОСТОКВАШИНО паст. питьевое цельное отборное... and flavors.",
    price: 91,
    rating: 3.5,
    discount: 50,
    image: "../assets/images/Home/home-card-images/img-2.png",
  },
  {
    ...
    category: "Meat",
    description:
      "Молоко ПРОСТОКВАШИНО паст. питьевое цельное отборное...of protein in meals.",
    price: 68,
    rating: 3.5,
    discount: 20,
    image: "../assets/images/Home/home-card-images/img-3.png",
  },
  {
    ...
    category: "Dessert",
    description:
      "Колбаса сырокопченая МЯСНАЯ ИСТОРИЯ Сальчичон и Тоскан... В корзину fections.",
    price: 61,
    rating: 4.5,
    discount: 20,
    image: "../assets/images/Home/home-card-images/img-4.png",
